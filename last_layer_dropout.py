...
class InferenceDropout(tfkl.Dropout):
    def call(self, inputs, training=None):
        return super(InferenceDropout, self).call(inputs, training=1)
...
def add_dense_dropout(layer_list,
  ...
  layer_list.append(tfkl.Dense(dense_units,
                               dense_activation))
  layer_list.append(InferenceDropout(dropout_rate))
